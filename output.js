//Thu Nov 27 2025 10:02:56 GMT+0000 (Coordinated Universal Time)
...
(() => {
  ...
  class _0x56c73a {
    ...
    static debug = (..._0x38b7c8) => {
      _0x56c73a.#o < 4 || (_0x38b7c8 = _0x38b7c8.map(_0x2e9e8c => "🅱️ " + _0x2e9e8c), _0x56c73a.log(..._0x38b7c8));
    };
    ...
    static info(..._0x512c61) {
      _0x56c73a.#o < 3 || (_0x512c61 = _0x512c61.map(_0x1d2228 => "ℹ️ " + _0x1d2228), _0x56c73a.log(..._0x512c61));
    }
    static #o = 2;
    static get logLevel() {
      switch (_0x56c73a.#o) {
    ...
    static log = (..._0xe5a2a) => {
      0 !== _0x56c73a.#o && (_0xe5a2a = _0xe5a2a.map(_0x1a2199 => {
      ...
      }), _0xe5a2a = ["", ..._0xe5a2a], console.log(_0xe5a2a.join("\n")));
    };
    ...
    static timeLog = (_0x1da69e = "default") => {
      ...
      _0x4295ed ? _0x56c73a.log(_0x1da69e + ": " + (Date.now() - _0x4295ed) + "ms") : _0x56c73a.warn("Timer \"" + _0x1da69e + "\" doesn’t exist");
    };
    static warn(..._0xf1c0fa) {
      _0x56c73a.#o < 2 || (_0xf1c0fa = _0xf1c0fa.map(_0x52db1b => "⚠️ " + _0x52db1b), _0x56c73a.log(..._0xf1c0fa));
    }
  }
  class _0x2c098a {
    static get(_0x1a3d5b = {}, _0x5979f7 = "", _0x47497c = undefined) {
      Array.isArray(_0x5979f7) || (_0x5979f7 = _0x2c098a.toPath(_0x5979f7));
      const _0x57e98d = _0x5979f7.reduce((_0x579e52, _0x5f1f4e) => Object(_0x579e52)[_0x5f1f4e], _0x1a3d5b);
      return undefined === _0x57e98d ? _0x47497c : _0x57e98d;
    }
    static set(_0x5f0900, _0x58dd1a, _0x196b72) {
      Array.isArray(_0x58dd1a) || (_0x58dd1a = _0x2c098a.toPath(_0x58dd1a));
    ...
    static unset(_0xde9de2 = {}, _0x1bbc4a = "") {
      Array.isArray(_0x1bbc4a) || (_0x1bbc4a = _0x2c098a.toPath(_0x1bbc4a));
      ...
      case "object":
        {
          ...
          switch (_0x21940b) {
            ...
            case "Shadowrocket":
            default:
              if (_0x259f5b && (_0xa7c8af.action = "open-url", _0xa7c8af.url = _0x259f5b), _0x121753 && (_0xa7c8af.action = "clipboard", _0xa7c8af.text = _0x121753), _0x597f01) {
                switch (true) {
                  ...
                  default:
                    switch (_0xa7c8af["media-base64"] = _0x597f01, true) {
              ...
              _0x25b262["auto-dismiss"] && (_0xa7c8af["auto-dismiss"] = _0x25b262["auto-dismiss"]);
              _0x25b262.sound && (_0xa7c8af.sound = _0x25b262.sound);
              break;
            case "Loon":
              _0x259f5b && (_0xa7c8af.openUrl = _0x259f5b);
              _0x597f01?.["startsWith"]("http") && (_0xa7c8af.mediaUrl = _0x597f01);
              break;
            case "Quantumult X":
              _0x259f5b && (_0xa7c8af["open-url"] = _0x259f5b);
              _0x597f01?.["startsWith"]("http") && (_0xa7c8af["media-url"] = _0x597f01);
              _0x121753 && (_0xa7c8af["update-pasteboard"] = _0x121753);
            case "Node.js":
          }
          break;
        }
  ...
  async function _0x517ee6(_0x47b8eb, _0x30966d) {
    ...
    _0x47b8eb.method || (_0x47b8eb.method = "GET", (_0x47b8eb.body ?? _0x47b8eb.bodyBytes) && (_0x47b8eb.method = "POST"));
    ...
    switch (_0x21940b) {
      ...
      default:
        if (_0x47b8eb.timeout) {
          switch (_0x47b8eb.timeout = Number.parseInt(_0x47b8eb.timeout, 10), _0x21940b) {
            case "Loon":
            case "Shadowrocket":
            case "Stash":
            case "Egern":
        ...
        switch ("boolean" == typeof _0x47b8eb.redirection && (_0x47b8eb["auto-redirect"] = _0x47b8eb.redirection), _0x47b8eb.bodyBytes && !_0x47b8eb.body && (_0x47b8eb.body = _0x47b8eb.bodyBytes, _0x47b8eb.bodyBytes = undefined), (_0x47b8eb.headers?.["Accept"] || _0x47b8eb.headers?.["accept"])?.["split"](";")?.[0]) {
        ...
        return await new Promise((_0x1bb8c4, _0x523d7f) => {
          $httpClient[_0x2652d9](_0x47b8eb, (_0x182b8f, _0x2ae300, _0x5cbf59) => {
            _0x182b8f ? _0x523d7f(_0x182b8f) : (_0x2ae300.ok = /^2\d\d$/.test(_0x2ae300.status), _0x2ae300.statusCode = _0x2ae300.status, _0x5cbf59 && (_0x2ae300.body = _0x5cbf59, 1 == _0x47b8eb["binary-mode"] && (_0x2ae300.bodyBytes = _0x5cbf59)), _0x1bb8c4(_0x2ae300));
          });
        });
      case "Quantumult X":
        _0x47b8eb.policy && _0x2c098a.set(_0x47b8eb, "opts.policy", _0x47b8eb.policy);
        "boolean" == typeof _0x47b8eb["auto-redirect"] && _0x2c098a.set(_0x47b8eb, "opts.redirection", _0x47b8eb["auto-redirect"]);
        _0x47b8eb.body instanceof ArrayBuffer ? (_0x47b8eb.bodyBytes = _0x47b8eb.body, _0x47b8eb.body = undefined) : ArrayBuffer.isView(_0x47b8eb.body) ? (_0x47b8eb.bodyBytes = _0x47b8eb.body.buffer.slice(_0x47b8eb.body.byteOffset, _0x47b8eb.body.byteLength + _0x47b8eb.body.byteOffset), _0x47b8eb.body = undefined) : _0x47b8eb.body && (_0x47b8eb.bodyBytes = undefined);
        return await $task.fetch(_0x47b8eb).then(_0x7e4042 => {
          switch (_0x7e4042.ok = /^2\d\d$/.test(_0x7e4042.statusCode), _0x7e4042.status = _0x7e4042.statusCode, (_0x7e4042.headers?.["Content-Type"] ?? _0x7e4042.headers?.["content-type"])?.["split"](";")?.[0]) {
            case "application/protobuf":
            case "application/x-protobuf":
            case "application/vnd.google.protobuf":
            case "application/vnd.apple.flatbuffer":
      ...
      case "Node.js":
        {
          ...
          _0x47b8eb && (_0x47b8eb.headers = _0x47b8eb.headers ? _0x47b8eb.headers : {}, undefined === _0x47b8eb.headers.Cookie && undefined === _0x47b8eb.cookieJar && (_0x47b8eb.cookieJar = _0x4ab4e9));
          const {
            url: _0x506428,
            ..._0x700560
          } = _0x47b8eb;
          return await _0x578fbf[_0x2652d9](_0x506428, _0x700560).on("redirect", (_0x177bba, _0x35f741) => {
            try {
              if (_0x177bba.headers["set-cookie"]) {
                ...
                _0x3cb8b8 && _0x4ab4e9.setCookieSync(_0x3cb8b8, null);
                _0x35f741.cookieJar = _0x4ab4e9;
              }
            } catch (_0x312dc1) {
              _0x56c73a.error(_0x312dc1);
            }
          }).then(_0x126736 => (_0x126736.statusCode = _0x126736.status, _0x126736.body = _0xe6cc79.decode(_0x126736.rawBody, "utf-8"), _0x126736.bodyBytes = _0x126736.rawBody, _0x126736.ok = /^2\d\d$/.test(_0x126736.statusCode) || !_0x126736.statusCode && "OK" === _0x126736.statusMessage, _0x126736), _0x11e36b => Promise.reject(_0x11e36b.message));
        }
    }
  }
  class _0x1a6861 {
        ...
        case true:
          {
            ...
            "object" != typeof _0x21cfde && (_0x21cfde = {});
        ...
        case true:
          {
            ...
            "object" != typeof _0x3ecc79 && (_0x3ecc79 = {});
        ...
        case true:
          {
            ...
            "object" != typeof _0xc4ba21 && (_0xc4ba21 = {});
    ...
    static #i = (_0x191ebf = this.dataFile) => {
      if ("Node.js" === _0x21940b) {
        ...
        _0x2bbaca ? this.fs.writeFileSync(_0x5634b6, _0x29126b) : _0x2a3158 ? this.fs.writeFileSync(_0x19195e, _0x29126b) : this.fs.writeFileSync(_0x5634b6, _0x29126b);
      }
    };
  }
  function _0x3c056e(_0x7af867, _0x3c2229) {
    return function (_0x34acbb) {
      ...
      var _0x1d6e44 = null == _0x589a88 ? null : "undefined" != typeof Symbol && _0x589a88[Symbol.iterator] || _0x589a88["@@iterator"];
      if (null != _0x1d6e44) {
        var _0x2dd3ef;
        var _0x729f86;
        var _0xdf87b1;
        ...
        var _0x268122 = false;
        try {
          if (_0xdf87b1 = (_0x1d6e44 = _0x1d6e44.call(_0x589a88)).next, 0 === _0x36d90b) {
          ...
          try {
            if (!_0x26aa21 && null != _0x1d6e44.return && (_0x5975cf = _0x1d6e44.return(), Object(_0x5975cf) !== _0x5975cf)) {
              return;
            }
          } finally {
            if (_0x268122) {
      ...
      if (_0x1db1fc) {
        if ("string" == typeof _0x1db1fc) {
          return _0x5bed21(_0x1db1fc, _0x1a0955);
        }
        var _0x3a4e5e = {}.toString.call(_0x1db1fc).slice(8, -1);
        "Object" === _0x3a4e5e && _0x1db1fc.constructor && (_0x3a4e5e = _0x1db1fc.constructor.name);
        return "Map" === _0x3a4e5e || "Set" === _0x3a4e5e ? Array.from(_0x1db1fc) : "Arguments" === _0x3a4e5e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(_0x3a4e5e) ? _0x5bed21(_0x1db1fc, _0x1a0955) : undefined;
      }
  ...
  function _0x5bed21(_0x159ac4, _0x14f5d2) {
    (null == _0x14f5d2 || _0x14f5d2 > _0x159ac4.length) && (_0x14f5d2 = _0x159ac4.length);
    for (var _0x126543 = 0, _0x4eba24 = Array(_0x14f5d2); _0x126543 < _0x14f5d2; _0x126543++) {
      _0x4eba24[_0x126543] = _0x159ac4[_0x126543];
    }
    return _0x4eba24;
  }
  var _0x8489b5 = function (_0x417119) {
    if ("string" == typeof _0x417119) {
      return _0x417119;
    }
    try {
  ...
  function _0x2e4911(_0x123123, _0x49cde6) {
    return _0x49cde6 ? _0x123123.replace(/\/+$/, "") + "/" + _0x49cde6.replace(/^\/+/, "") : _0x123123;
  }
  function _0x5b1b22(_0x2131cb) {
    _0x5b1b22 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (_0x45c848) {
      return typeof _0x45c848;
    } : function (_0x38f3b6) {
      return _0x38f3b6 && "function" == typeof Symbol && _0x38f3b6.constructor === Symbol && _0x38f3b6 !== Symbol.prototype ? "symbol" : typeof _0x38f3b6;
    };
  ...
  function _0x170a8d(_0x46b7e6) {
    ...
    if (_0x4aa59b && _0x5ed2be && _0x45f11b) {
      ...
      var _0xe140a9 = function (_0x3f2173, _0x400561) {
        _0x3f2173 = [_0x3f2173[0] >>> 16, 65535 & _0x3f2173[0], _0x3f2173[1] >>> 16, 65535 & _0x3f2173[1]];
        _0x400561 = [_0x400561[0] >>> 16, 65535 & _0x400561[0], _0x400561[1] >>> 16, 65535 & _0x400561[1]];
      ...
      var _0x580edf = function (_0x4aafee, _0x56055) {
        _0x4aafee = [_0x4aafee[0] >>> 16, 65535 & _0x4aafee[0], _0x4aafee[1] >>> 16, 65535 & _0x4aafee[1]];
        _0x56055 = [_0x56055[0] >>> 16, 65535 & _0x56055[0], _0x56055[1] >>> 16, 65535 & _0x56055[1]];
      ...
      var _0x281e26 = function (_0x12399d, _0x314b42) {
        return 32 == (_0x314b42 %= 64) ? [_0x12399d[1], _0x12399d[0]] : _0x314b42 < 32 ? [_0x12399d[0] << _0x314b42 | _0x12399d[1] >>> 32 - _0x314b42, _0x12399d[1] << _0x314b42 | _0x12399d[0] >>> 32 - _0x314b42] : (_0x314b42 -= 32, [_0x12399d[1] << _0x314b42 | _0x12399d[0] >>> 32 - _0x314b42, _0x12399d[0] << _0x314b42 | _0x12399d[1] >>> 32 - _0x314b42]);
      };
      var _0x5a862c = function (_0x21febd, _0x32b5f4) {
        return 0 == (_0x32b5f4 %= 64) ? _0x21febd : _0x32b5f4 < 32 ? [_0x21febd[0] << _0x32b5f4 | _0x21febd[1] >>> 32 - _0x32b5f4, _0x21febd[1] << _0x32b5f4] : [_0x21febd[1] << _0x32b5f4 - 32, 0];
      };
      var _0x37f737 = function (_0x279d16, _0x5a6463) {
        return [_0x279d16[0] ^ _0x5a6463[0], _0x279d16[1] ^ _0x5a6463[1]];
      };
      var _0x5f5525 = function (_0x132587) {
      ...
      var _0xe60fb9 = function (_0x37a980, _0x277f7d) {
        _0x277f7d = _0x277f7d || 0;
        for (var _0x9ce8de = (_0x37a980 = _0x37a980 || "").length % 16, _0x5d3762 = _0x37a980.length - _0x9ce8de, _0x25d387 = [0, _0x277f7d], _0x2a3d64 = [0, _0x277f7d], _0x1ad967 = [0, 0], _0x1fbb5c = [0, 0], _0x1edff5 = [2277735313, 289559509], _0x5de1e6 = [1291169091, 658871167], _0x5c92ce = 0; _0x5c92ce < _0x5d3762; _0x5c92ce += 16) {
          _0x1ad967 = [255 & _0x37a980.charCodeAt(_0x5c92ce + 4) | (255 & _0x37a980.charCodeAt(_0x5c92ce + 5)) << 8 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 6)) << 16 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 7)) << 24, 255 & _0x37a980.charCodeAt(_0x5c92ce) | (255 & _0x37a980.charCodeAt(_0x5c92ce + 1)) << 8 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 2)) << 16 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 3)) << 24];
          _0x1fbb5c = [255 & _0x37a980.charCodeAt(_0x5c92ce + 12) | (255 & _0x37a980.charCodeAt(_0x5c92ce + 13)) << 8 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 14)) << 16 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 15)) << 24, 255 & _0x37a980.charCodeAt(_0x5c92ce + 8) | (255 & _0x37a980.charCodeAt(_0x5c92ce + 9)) << 8 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 10)) << 16 | (255 & _0x37a980.charCodeAt(_0x5c92ce + 11)) << 24];
        ...
        switch (_0x1ad967 = [0, 0], _0x1fbb5c = [0, 0], _0x9ce8de) {
          case 15:
      ...
      var _0xeb0399 = {
        fp_infos: function (_0x54fbf8) {
          ...
          for (var _0x49d1c6 in _0x54fbf8) {
            ...
            "string" == typeof _0x36fd3f && -1 != _0x36fd3f.indexOf("Error: ") ? _0x5eb307.errors[_0x5d1bd6] = _0x36fd3f : _0x5eb307[_0x5d1bd6] = _0x36fd3f;
          }
          ...
          _0x5eb307.fp = function (_0x3f7d30, _0x39ac38) {
            var _0x80bde2 = [_0x3f7d30.plugins && _0x3f7d30.plugins.fp, _0x3f7d30.fonts && _0x3f7d30.fonts.fp, _0x3f7d30.screenObject.colorDepth, _0x3f7d30.intlObject, _0x3f7d30.deviceInfos, _0x3f7d30.touchSupport, _0x3f7d30.navigatorObject.platform, _0x3f7d30.navigatorObject.vendor, _0x3f7d30.storageObject, _0x3f7d30.functions, _0x3f7d30.audio, "object" == _0x5b1b22(_0x3f7d30.webGL) ? _0x3f7d30.webGL.fp : undefined, "object" == _0x5b1b22(_0x3f7d30.canvas) ? _0x3f7d30.canvas.fp : undefined];
            for (var _0x3aff4 in _0x80bde2) undefined === _0x80bde2[_0x3aff4] && (_0x80bde2[_0x3aff4] = "");
          ...
          (function () {
            ...
            for (var _0x2ff932 in _0x5eb307) {
              ...
              if ("object" == _0x5b1b22(_0xd48855)) {
                var _0x38724f = 0;
                for (var _0x30f2d3 in _0xd48855) {
                  var _0x15f5aa = _0xd48855[_0x30f2d3];
                  _0x38724f += "number" == typeof _0x15f5aa ? parseInt(_0x15f5aa) : "string" == typeof _0x15f5aa ? _0x15f5aa.length : _0x47a4c3;
                }
                _0x38724f && (_0x5eb307[_0x2ff932].verify = _0x38724f * _0x47a4c3);
              }
            }
          })();
          return _0x5eb307;
        }([_0x50e9f6, _0x4cf90d, _0x45a0c7, _0x6c2d8, _0xecd988, _0x21d756, _0x137f02, _0x5bdff8, _0xc5d5af, _0x2a8149, _0x4973db, _0x349294, _0x4a8271]),
        answer: function () {
          for (var _0x59c88d = 0, _0x4ad292 = 1, _0x52371e = 0; _0x52371e < _0x4aa59b.length; _0x52371e++) {
            _0x59c88d = 2 * (_0x59c88d + _0x4aa59b.charCodeAt(_0x52371e));
            _0x4ad292 = 2 * (_0x4ad292 + _0x52371e + 1);
          }
          _0x59c88d *= _0x5ed2be;
      ...
      return function (_0x847268) {
        ...
        for (_0x4aab1 = _0x847268.length, _0x1700af = 0, _0x3cfea0 = ""; _0x1700af < _0x4aab1;) {
          if (_0x44c87b = 255 & _0x847268.charCodeAt(_0x1700af++), _0x1700af == _0x4aab1) {
            _0x3cfea0 += _0x9ae7fb.charAt(_0x44c87b >> 2);
            _0x3cfea0 += _0x9ae7fb.charAt((3 & _0x44c87b) << 4);
            _0x3cfea0 += "==";
            break;
          }
          if (_0x580d49 = _0x847268.charCodeAt(_0x1700af++), _0x1700af == _0x4aab1) {
            _0x3cfea0 += _0x9ae7fb.charAt(_0x44c87b >> 2);
            _0x3cfea0 += _0x9ae7fb.charAt((3 & _0x44c87b) << 4 | (240 & _0x580d49) >> 4);
            _0x3cfea0 += _0x9ae7fb.charAt((15 & _0x580d49) << 2);
            _0x3cfea0 += "=";
            break;
          }
          ...
          _0x3cfea0 += _0x9ae7fb.charAt(_0x44c87b >> 2);
          _0x3cfea0 += _0x9ae7fb.charAt((3 & _0x44c87b) << 4 | (240 & _0x580d49) >> 4);
          _0x3cfea0 += _0x9ae7fb.charAt((15 & _0x580d49) << 2 | (192 & _0x594a11) >> 6);
          _0x3cfea0 += _0x9ae7fb.charAt(63 & _0x594a11);
        }
        return _0x3cfea0;
  ...
  function _0x5a8d63(_0x1f75e0) {
    _0x5a8d63 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (_0x2af9c5) {
      return typeof _0x2af9c5;
    } : function (_0x2bca75) {
      return _0x2bca75 && "function" == typeof Symbol && _0x2bca75.constructor === Symbol && _0x2bca75 !== Symbol.prototype ? "symbol" : typeof _0x2bca75;
    };
    return _0x5a8d63(_0x1f75e0);
  }
  var _0x4d8b07 = "undefined" != typeof $argument ? "object" == ("undefined" == typeof $argument ? "undefined" : _0x5a8d63($argument)) ? $argument : Object.fromEntries($argument.split("&").map(function (_0x21561a) {
    return _0x21561a.split("=");
  })) : {};
  function _0x4c2b88(_0x14fd11) {
    _0x4c2b88 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (_0x1d821d) {
      return typeof _0x1d821d;
    } : function (_0x575c35) {
      return _0x575c35 && "function" == typeof Symbol && _0x575c35.constructor === Symbol && _0x575c35 !== Symbol.prototype ? "symbol" : typeof _0x575c35;
    };
  ...
  function _0x49d68e(_0x4324aa, _0x3a6445) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      _0x3a6445 && (_0x212209 = _0x212209.filter(function (_0x17ef30) {
  ...
  function _0x22ec9e(_0x9925ce) {
    for (var _0x5445e1 = 1; _0x5445e1 < arguments.length; _0x5445e1++) {
      var _0x458053 = null != arguments[_0x5445e1] ? arguments[_0x5445e1] : {};
      _0x5445e1 % 2 ? _0x49d68e(Object(_0x458053), true).forEach(function (_0x46602b) {
        _0x1f3244(_0x9925ce, _0x46602b, _0x458053[_0x46602b]);
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(_0x9925ce, Object.getOwnPropertyDescriptors(_0x458053)) : _0x49d68e(Object(_0x458053)).forEach(function (_0x11be2b) {
  ...
  function _0x1f3244(_0x4b67b, _0x406078, _0x3a4a60) {
    (_0x406078 = function (_0x42e3ed) {
      var _0x2b36e3 = function (_0x137758, _0x3554dc) {
        if ("object" != _0x4c2b88(_0x137758) || !_0x137758) {
          return _0x137758;
        }
        var _0x331e34 = _0x137758[Symbol.toPrimitive];
        if (undefined !== _0x331e34) {
          var _0x490b47 = _0x331e34.call(_0x137758, _0x3554dc || "default");
          if ("object" != _0x4c2b88(_0x490b47)) {
            return _0x490b47;
          }
          throw new TypeError("@@toPrimitive must return a primitive value.");
        }
        return ("string" === _0x3554dc ? String : Number)(_0x137758);
      }(_0x42e3ed, "string");
      return "symbol" == _0x4c2b88(_0x2b36e3) ? _0x2b36e3 : _0x2b36e3 + "";
    }(_0x406078)) in _0x4b67b ? Object.defineProperty(_0x4b67b, _0x406078, {
      value: _0x3a4a60,
      enumerable: true,
      configurable: true,
      writable: true
  ...
  function _0x2570ae(_0x337e2a, _0x12feeb) {
    return function (_0x1592e2) {
      ...
      var _0x5030b4 = null == _0xd0d733 ? null : "undefined" != typeof Symbol && _0xd0d733[Symbol.iterator] || _0xd0d733["@@iterator"];
      if (null != _0x5030b4) {
        var _0x2ed9c6;
        var _0x302cdc;
        var _0x2c0afc;
        ...
        var _0x6f1bb9 = false;
        try {
          if (_0x2c0afc = (_0x5030b4 = _0x5030b4.call(_0xd0d733)).next, 0 === _0xe9779c) {
          ...
          try {
            if (!_0x23c759 && null != _0x5030b4.return && (_0xda6749 = _0x5030b4.return(), Object(_0xda6749) !== _0xda6749)) {
              return;
            }
          } finally {
            if (_0x6f1bb9) {
      ...
      if (_0x139ca4) {
        if ("string" == typeof _0x139ca4) {
          return _0x32324b(_0x139ca4, _0x3d8f8e);
        }
        var _0x57251b = {}.toString.call(_0x139ca4).slice(8, -1);
        "Object" === _0x57251b && _0x139ca4.constructor && (_0x57251b = _0x139ca4.constructor.name);
        return "Map" === _0x57251b || "Set" === _0x57251b ? Array.from(_0x139ca4) : "Arguments" === _0x57251b || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(_0x57251b) ? _0x32324b(_0x139ca4, _0x3d8f8e) : undefined;
      }
  ...
  function _0x32324b(_0x5318f8, _0x262eec) {
    (null == _0x262eec || _0x262eec > _0x5318f8.length) && (_0x262eec = _0x5318f8.length);
  ...
  function _0x4ab11a() {
    ...
    var _0x5623eb = {
      wrap: _0x478057,
      isGeneratorFunction: function (_0x902acc) {
        var _0x345452 = "function" == typeof _0x902acc && _0x902acc.constructor;
        return !!_0x345452 && (_0x345452 === _0x2e0426 || "GeneratorFunction" === (_0x345452.displayName || _0x345452.name));
      },
      mark: function (_0x384d7e) {
        Object.setPrototypeOf ? Object.setPrototypeOf(_0x384d7e, _0x423f29) : (_0x384d7e.__proto__ = _0x423f29, _0x4d9b01(_0x384d7e, _0x513db4, "GeneratorFunction"));
        _0x384d7e.prototype = Object.create(_0x302201);
        return _0x384d7e;
      },
      awrap: function (_0x3271c1) {
        var _0x1b1dd6 = {
          __await: _0x3271c1
        };
        return _0x1b1dd6;
      },
      AsyncIterator: _0x26476b,
      async: function (_0x1b904d, _0x1fd780, _0x2e1592, _0x108254, _0x575372) {
        undefined === _0x575372 && (_0x575372 = Promise);
        var _0x580e20 = new _0x26476b(_0x478057(_0x1b904d, _0x1fd780, _0x2e1592, _0x108254), _0x575372);
        return _0x5623eb.isGeneratorFunction(_0x1fd780) ? _0x580e20 : _0x580e20.next().then(function (_0x3ca9fd) {
          return _0x3ca9fd.done ? _0x3ca9fd.value : _0x580e20.next();
        });
      }
    };
    ...
    var _0x43a95c = "function" == typeof Symbol ? Symbol : {};
    ...
    _0x5431af && _0x5431af !== _0x5bf2b5 && _0x395f14.call(_0x5431af, _0x360c05) && (_0x2c8607 = _0x5431af);
    _0x423f29.prototype = _0x480752.prototype = Object.create(_0x2c8607);
    var _0x302201 = _0x423f29.prototype;
    ...
    function _0x26476b(_0x4fc67c, _0x4807a1) {
      function _0x593ec3(_0x177772, _0x4a9761, _0x5898f5, _0x5c8de4) {
        ...
        if ("throw" !== _0x34baf5.type) {
          var _0x2fc002 = _0x34baf5.arg;
          var _0x2474ed = _0x2fc002.value;
          return _0x2474ed && "object" == _0x4c2b88(_0x2474ed) && _0x395f14.call(_0x2474ed, "__await") ? _0x4807a1.resolve(_0x2474ed.__await).then(function (_0x4c2acb) {
            _0x593ec3("next", _0x4c2acb, _0x5898f5, _0x5c8de4);
          }, function (_0x338ec5) {
            _0x593ec3("throw", _0x338ec5, _0x5898f5, _0x5c8de4);
          }) : _0x4807a1.resolve(_0x2474ed).then(function (_0x1d9325) {
    ...
    function _0x403057(_0x587afb, _0x780499, _0x539ff) {
      ...
      return function (_0x5f780a, _0x5ee4a3) {
        ...
        for (_0x539ff.method = _0x5f780a, _0x539ff.arg = _0x5ee4a3;;) {
          ...
          if ("next" === _0x539ff.method) {
            _0x539ff.sent = _0x539ff._sent = _0x539ff.arg;
          } else {
            if ("throw" === _0x539ff.method) {
              if (_0x4272ad === _0x2b9996) {
                throw _0x4272ad = _0x427aaa, _0x539ff.arg;
              }
              _0x539ff.dispatchException(_0x539ff.arg);
            } else {
              "return" === _0x539ff.method && _0x539ff.abrupt("return", _0x539ff.arg);
            }
          }
          _0x4272ad = _0x4c3b5d;
          var _0x18c354 = _0x43713d(_0x587afb, _0x780499, _0x539ff);
          if ("normal" === _0x18c354.type) {
            if (_0x4272ad = _0x539ff.done ? _0x427aaa : _0x4f22ac, _0x18c354.arg === _0x2f41e3) {
              continue;
            }
            var _0x5f51d9 = {
              value: _0x18c354.arg,
          ...
          "throw" === _0x18c354.type && (_0x4272ad = _0x427aaa, _0x539ff.method = "throw", _0x539ff.arg = _0x18c354.arg);
        }
      };
    }
    function _0x30cb86(_0xcba7c7, _0x4c08b9) {
      ...
      if (_0x3073c9 === _0x4ad9a7) {
        ...
        "throw" === _0x42ed4e && _0xcba7c7.iterator.return && (_0x4c08b9.method = "return", _0x4c08b9.arg = _0x4ad9a7, _0x30cb86(_0xcba7c7, _0x4c08b9), "throw" === _0x4c08b9.method) || "return" !== _0x42ed4e && (_0x4c08b9.method = "throw", _0x4c08b9.arg = new TypeError("The iterator does not provide a '" + _0x42ed4e + "' method"));
        return _0x2f41e3;
      }
      var _0x4865f8 = _0x43713d(_0x3073c9, _0xcba7c7.iterator, _0x4c08b9.arg);
      if ("throw" === _0x4865f8.type) {
      ...
      return _0x4b589e ? _0x4b589e.done ? (_0x4c08b9[_0xcba7c7.resultName] = _0x4b589e.value, _0x4c08b9.next = _0xcba7c7.nextLoc, "return" !== _0x4c08b9.method && (_0x4c08b9.method = "next", _0x4c08b9.arg = _0x4ad9a7), _0x4c08b9.delegate = null, _0x2f41e3) : _0x4b589e : (_0x4c08b9.method = "throw", _0x4c08b9.arg = new TypeError("iterator result is not an object"), _0x4c08b9.delegate = null, _0x2f41e3);
    }
    function _0x535c24(_0x2ee799) {
      var _0x12afb8 = {
        tryLoc: _0x2ee799[0]
      };
      1 in _0x2ee799 && (_0x12afb8.catchLoc = _0x2ee799[1]);
      2 in _0x2ee799 && (_0x12afb8.finallyLoc = _0x2ee799[2], _0x12afb8.afterLoc = _0x2ee799[3]);
    ...
    function _0x2a355a(_0x5260dc) {
      if (_0x5260dc || "" === _0x5260dc) {
        ...
        if ("function" == typeof _0x5260dc.next) {
          return _0x5260dc;
        }
        if (!isNaN(_0x5260dc.length)) {
          var _0x275eab = -1;
          var _0x166f84 = function _0x541a4a() {
            for (; ++_0x275eab < _0x5260dc.length;) {
    ...
    _0x5623eb.keys = function (_0x53d83a) {
      ...
      var _0x4b2779 = [];
      for (var _0x455f17 in _0xdb906b) _0x4b2779.push(_0x455f17);
      _0x4b2779.reverse();
      return function _0x45d70c() {
        for (; _0x4b2779.length;) {
    ...
    _0x171cee.prototype = {
      ...
      reset: function (_0x3fbfb5) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = _0x4ad9a7, this.done = false, this.delegate = null, this.method = "next", this.arg = _0x4ad9a7, this.tryEntries.forEach(_0x2f848d), !_0x3fbfb5) {
          for (var _0x206800 in this) "t" === _0x206800.charAt(0) && _0x395f14.call(this, _0x206800) && !isNaN(+_0x206800.slice(1)) && (this[_0x206800] = _0x4ad9a7);
        }
      },
      stop: function () {
        this.done = true;
        var _0x1a6181 = this.tryEntries[0].completion;
        if ("throw" === _0x1a6181.type) {
          throw _0x1a6181.arg;
        }
        return this.rval;
      },
      dispatchException: function (_0x25b295) {
        ...
        function _0xee2256(_0x2a6aaf, _0x43d7a5) {
          ...
          _0x43d7a5 && (_0x516f0c.method = "next", _0x516f0c.arg = _0x4ad9a7);
          return !!_0x43d7a5;
        }
      ...
      abrupt: function (_0xad083e, _0x3b54e4) {
        ...
        _0x2cfb64 && ("break" === _0xad083e || "continue" === _0xad083e) && _0x2cfb64.tryLoc <= _0x3b54e4 && _0x3b54e4 <= _0x2cfb64.finallyLoc && (_0x2cfb64 = null);
        var _0x912f71 = _0x2cfb64 ? _0x2cfb64.completion : {};
        _0x912f71.type = _0xad083e;
        _0x912f71.arg = _0x3b54e4;
        return _0x2cfb64 ? (this.method = "next", this.next = _0x2cfb64.finallyLoc, _0x2f41e3) : this.complete(_0x912f71);
      },
      complete: function (_0x53f4ec, _0x1725a3) {
        if ("throw" === _0x53f4ec.type) {
          throw _0x53f4ec.arg;
        }
        "break" === _0x53f4ec.type || "continue" === _0x53f4ec.type ? this.next = _0x53f4ec.arg : "return" === _0x53f4ec.type ? (this.rval = this.arg = _0x53f4ec.arg, this.method = "return", this.next = "end") : "normal" === _0x53f4ec.type && _0x1725a3 && (this.next = _0x1725a3);
        return _0x2f41e3;
      },
      ...
      delegateYield: function (_0x3711f3, _0x4315b5, _0x4eacdc) {
        ...
        "next" === this.method && (this.arg = _0x4ad9a7);
        return _0x2f41e3;
      }
    };
    return _0x5623eb;
  ...
  function _0x2d149a(_0x2ccb27, _0x1d757a, _0x8ac7c, _0x1373fb, _0x4bfc5e, _0x23014e, _0x261d4c) {
    try {
      ...
      return void _0x8ac7c(_0xefcc8e);
    }
    _0x2bc622.done ? _0x1d757a(_0xba2173) : Promise.resolve(_0xba2173).then(_0x1373fb, _0x4bfc5e);
  }
  ...
  var _0x10f784 = function () {
    return "Node.js" === _0x21940b;
  };
  var _0x4dc7b3 = {
    timeZone: "PRC"
  };
  _0x1e3570 = ["本脚本仅用于学习研究，禁止用于商业用途", "本脚本不保证准确性、可靠性、完整性和及时性", "任何个人或组织均可无需经过通知而自由使用", "作者对任何脚本问题概不负责，包括由此产生的任何损失", "如有单位或个人认为本脚本侵权，请通知并提供证明，我将删除", "请勿将本脚本用于商业用途，由此引起的问题与作者无关", "本脚本及其更新版权归作者所有", "", "⌚ ".concat(new Date().toLocaleString("zh-CN", _0x4dc7b3))];
  _0x56c73a.log.apply(_0x56c73a, ["==============📣免责声明📣=============="].concat(_0x1e3570));
  _0x56c73a.logLevel = "true" === "".concat(_0x10f784() ? process.env.WUAI_DEBUG : _0x4d8b07.debug || _0x1a6861.getItem("wuai_debug")) ? "debug" : "info";
  _0x56c73a.info("日志等级: ".concat(_0x56c73a.logLevel));
        ...
        for (;;) {
          switch (_0x21b43d.prev = _0x21b43d.next) {
            ...
            case 21:
              ...
              return _0x2ca2d4();
            case 23:
              if (_0x1613ee = _0x21b43d.sent, _0x1613ee) {
                _0x21b43d.next = 28;
                break;
              }
              _0x21b43d.next = 27;
            ...
            case 30:
              _0x21b43d.next = 32;
              return _0x579114(_0x4fc00b, "".concat(user.name, "[").concat("".concat(user.id).replace(/(\d{3})\d+(\d{2})/, "$1****$2"), "]"), msgBody);
            case 32:
            case "end":
      ...
      return _0x4ab11a().wrap(function (_0x1b2e49) {
        for (;;) {
          switch (_0x1b2e49.prev = _0x1b2e49.next) {
            ...
            case 3:
              if (_0x41c724 = _0x1b2e49.sent, !_0x41c724.ok) {
                _0x1b2e49.next = 16;
                break;
              }
              if (_0x42b89b = _0x41c724.body, !_0x42b89b.match(/(ÏÈµÇÂ¼|\u9700\u8981\u5148\u767b\u5f55|�Ҫ�ȵ�¼���ܼ�)/)) {
                _0x1b2e49.next = 10;
                break;
              }
              _0x1b2e49.next = 9;
            ...
            case 10:
              ...
              _0x56c73a.log("用户信息: ".concat(_0x2181f5, " - ").concat(_0x484458));
              _0x1b2e49.next = 17;
              break;
            case 16:
      ...
      return _0x4ab11a().wrap(function (_0x35b8fa) {
        for (;;) {
          switch (_0x35b8fa.prev = _0x35b8fa.next) {
            ...
            case 3:
              if (_0x29f874 = _0x35b8fa.sent, !_0x29f874.ok) {
                _0x35b8fa.next = 24;
                break;
              }
              if (_0x4a7700 = _0x4b899f(_0x4a7700, _0x1a2461(_0x29f874)), _0x56c73a.debug("[混淆接口]更新Cookie: ".concat(_0x4a7700)), _0x39fdfa = null === (_0x33e501 = /(?:LZ|ZL)\s*=\s*['"]([0-9]{5,6})['"]/.exec(_0x29f874.body)) || undefined === _0x33e501 ? undefined : _0x33e501[1], _0x39fdfa) {
                _0x35b8fa.next = 10;
                break;
              }
              throw new Error("[LZ] 长度参数获取失败");
            case 10:
              if (_0x4e6340 = null === (_0x38da13 = /(?:LJ|ZR)\s*=\s*['"]([0-9]{5,6})['"]/.exec(_0x29f874.body)) || undefined === _0x38da13 ? undefined : _0x38da13[1], _0x4e6340) {
                _0x35b8fa.next = 13;
                break;
              }
              throw new Error("[LJ] 乘数因子获取失败");
            case 13:
              if (_0x4d515b = null === (_0x4821bb = /(?:Zn|LE)\s*=\s*['"]([0-9a-zA-Z\/+.-]+={0,2})['"];/.exec(_0x29f874.body)) || undefined === _0x4821bb ? undefined : _0x4821bb[1], _0x4d515b) {
                _0x35b8fa.next = 16;
                break;
              }
            ...
            case 16:
              ...
              _0x56c73a.debug("[LZ] 长度参数: ".concat(_0x37721e.LZ), "[LJ] 乘数因子: ".concat(_0x37721e.LJ), "[LE] 加密参数: ".concat(_0x37721e.LE));
              _0x56c73a.groupEnd();
              globalThis.verifyBody = _0x170a8d(_0x37721e);
              _0x56c73a.debug("[verifyBody] 加密结果: ".concat(globalThis.verifyBody));
              _0x35b8fa.next = 25;
              break;
            case 24:
      ...
      return _0x4ab11a().wrap(function (_0x3ff0b5) {
        for (;;) {
          switch (_0x3ff0b5.prev = _0x3ff0b5.next) {
            ...
            case 3:
              if (_0x584632 = _0x3ff0b5.sent, !_0x584632.ok) {
                _0x3ff0b5.next = 10;
                break;
              }
        ...
        for (;;) {
          switch (_0x3bfdd3.prev = _0x3bfdd3.next) {
            ...
            case 3:
              ...
              _0x4a92b9 = new Date();
              _0x2e0a86.match(/(ÒÑÍê³É|\u606d\u559c\u60a8|��̳΢�š��ᰮ�ƽ�)/) ? _0x2ea368.msgBody = _0x4a92b9.getMonth() + 1 + "月" + _0x4a92b9.getDate() + "日, 签到成功 🎉" : _0x2e0a86.match(/(ÄúÒÑ|\u4e0b\u671f\u518d\u6765|>��Ǹ������)/) ? _0x2ea368.msgBody = _0x4a92b9.getMonth() + 1 + "月" + _0x4a92b9.getDate() + "日, 已签过 ⚠️" : _0x2e0a86.match(/(ÏÈµÇÂ¼|\u9700\u8981\u5148\u767b\u5f55|�Ҫ�ȵ�¼���ܼ�)/) ? _0x2ea368.msgBody = "签到失败, Cookie失效 ‼️‼️" : 403 == _0x389c57.statusCode ? _0x2ea368.msgBody = "服务器暂停签到 ⚠️" : _0x2ea368.msgBody = "脚本待更新 ‼️‼️";
            case 8:
            case "end":
  ...
  function _0x5706a9(_0x278df9) {
    ...
    var _0x33c658;
    if (!_0x278df9) {
      throw _0x136460(_0x4fc00b, "❌ 获取Cookie失败", "Cookie为空, 不进行初始化"), new Error("Cookie为空, 不进行初始化");
    }
    if (_0x278df9 = _0x4d66d7(_0x278df9), null === (_0x495efb = _0x278df9) || undefined === _0x495efb || !_0x495efb.htVC_2132_auth) {
      throw new Error("获取Cookie失败, 关键值[auth]缺失");
    }
    if (null === (_0x33c658 = _0x278df9) || undefined === _0x33c658 || !_0x33c658.htVC_2132_saltkey) {
      throw new Error("获取Cookie失败, 关键值[saltkey]缺失");
    }
    return "htVC_2132_auth=".concat(_0x278df9.htVC_2132_auth, "; htVC_2132_saltkey=").concat(_0x278df9.htVC_2132_saltkey, ";");
  }
  function _0x4d66d7(_0x5559a8) {
    return _0x5559a8.split(";").reduce(function (_0x3c93f4, _0xf7ad96) {
      ...
      _0x3e95f2 && _0x9a2a3a && (_0x3c93f4[_0x3e95f2] = _0x9a2a3a);
      return _0x3c93f4;
    }, {});
  }
  function _0x140e1c() {
    var _0x6b62b5;
    var _0x1d753d;
    var _0x263abb = _0x5706a9(null !== (_0x6b62b5 = null !== (_0x1d753d = $request.headers.Cookie) && undefined !== _0x1d753d ? _0x1d753d : $request.headers.cookie) && undefined !== _0x6b62b5 ? _0x6b62b5 : "");
    if (!_0x263abb || !_0x263abb.includes("auth=")) {
      throw _0x136460(_0x4fc00b, "❌ 获取Cookie失败", "请检查Cookie是否正确"), new Error("请检查Cookie是否正确");
    }
    _0x1a6861.setItem("wuai_cookie", _0x263abb);
    _0x56c73a.debug("Cookie: ".concat(_0x263abb));
        ...
        for (;;) {
          switch (_0x3bdbd8.prev = _0x3bdbd8.next) {
            case 0:
              ...
              _0xd90bdd = _0x320017.length > 3 && undefined !== _0x320017[3] ? _0x320017[3] : {};
              _0x266799 = (null == _0xd90bdd ? undefined : _0xd90bdd["open-url"]) || (null == _0xd90bdd ? undefined : _0xd90bdd.openUrl) || (null == _0xd90bdd ? undefined : _0xd90bdd.$open) || (null == _0xd90bdd ? undefined : _0xd90bdd.url) || "";
              _0x4e6faf = (null == _0xd90bdd ? undefined : _0xd90bdd["update-pasteboard"]) || (null == _0xd90bdd ? undefined : _0xd90bdd.updatePasteboard) || (null == _0xd90bdd ? undefined : _0xd90bdd.$copy) || (null == _0xd90bdd ? undefined : _0xd90bdd.copy) || "";
              _0xba54cb = (null == _0xd90bdd ? undefined : _0xd90bdd["media-url"]) || (null == _0xd90bdd ? undefined : _0xd90bdd.mediaUrl) || (null == _0xd90bdd ? undefined : _0xd90bdd.$media) || "";
            ...
            case 9:
              ...
              _0x56c73a.info("Bark第".concat(_0x273d5a + 1, "次推送尝试"));
              _0x3bdbd8.next = 13;
              return _0x517ee6(_0x2ef7cf);
            case 13:
              if (_0x4c96e8 = _0x3bdbd8.sent, !_0x4c96e8.ok) {
                _0x3bdbd8.next = 23;
                break;
              }
              _0x16377f = ["=========📣推送成功📣=========", _0xa80df7, _0x473e12];
              _0x266799 && _0x16377f.push("跳转链接: ".concat(_0x266799));
              _0x4e6faf && _0x16377f.push("复制内容: ".concat(_0x4e6faf));
              _0xba54cb && _0x16377f.push("媒体链接: ".concat(_0xba54cb));
  ...
  function _0x1a2461(_0x42dfca) {
    ...
    return Array.isArray(_0x5c0bcb) ? _0x5c0bcb.map(function (_0x72924c) {
      return _0x72924c.split(";")[0];
    }).join(";") : (null == _0x5c0bcb || null === (_0x4f43a9 = _0x5c0bcb.split(",")) || undefined === _0x4f43a9 || null === (_0x4f43a9 = _0x4f43a9.map(function (_0x4ae622) {
      return _0x4ae622.split(";")[0];
    })) || undefined === _0x4f43a9 ? undefined : _0x4f43a9.join(";")) || _0x5c0bcb;
  }
  function _0x4b899f(_0x3cf81d, _0x32bba7) {
    ...
    return Object.entries(Object.assign(_0x2d3ac6, _0x4d750f)).map(function (_0x1077d3) {
      ...
      return "".concat(_0x3862b9, "=").concat(_0x557c05);
    }).join("; ");
  }
  _0x56c73a.debug("Cookie: ".concat(_0x4a7700));
  _0x44708d(_0x4ab11a().mark(function _0x532996() {
    ...
    switch (_0x21940b) {
      case "Surge":
        _0x232cf.policy && _0x2c098a.set(_0x232cf, "headers.X-Surge-Policy", _0x232cf.policy);
        _0x56c73a.log("🚩 执行结束!", "🕛 " + (new Date().getTime() / 1000 - $script.startTime) + " 秒");
        $done(_0x232cf);
        break;
      case "Loon":
        _0x232cf.policy && (_0x232cf.node = _0x232cf.policy);
        _0x56c73a.log("🚩 执行结束!", "🕛 " + (new Date() - $script.startTime) / 1000 + " 秒");
        $done(_0x232cf);
        break;
      case "Stash":
        _0x232cf.policy && _0x2c098a.set(_0x232cf, "headers.X-Stash-Selected-Proxy", encodeURI(_0x232cf.policy));
        _0x56c73a.log("🚩 执行结束!", "🕛 " + (new Date() - $script.startTime) / 1000 + " 秒");
        $done(_0x232cf);
        break;
      case "Egern":
      ...
      default:
        ...
        break;
      case "Quantumult X":
        switch (_0x232cf.policy && _0x2c098a.set(_0x232cf, "opts.policy", _0x232cf.policy), _0x232cf["auto-redirect"] = undefined, _0x232cf["auto-cookie"] = undefined, _0x232cf["binary-mode"] = undefined, _0x232cf.charset = undefined, _0x232cf.host = undefined, _0x232cf.insecure = undefined, _0x232cf.method = undefined, _0x232cf.ok = undefined, _0x232cf.opt = undefined, _0x232cf.path = undefined, _0x232cf.policy = undefined, _0x232cf["policy-descriptor"] = undefined, _0x232cf.scheme = undefined, _0x232cf.sessionIndex = undefined, _0x232cf.statusCode = undefined, _0x232cf.timeout = undefined, typeof _0x232cf.status) {
          case "number":
        ...
        _0x232cf.body instanceof ArrayBuffer ? (_0x232cf.bodyBytes = _0x232cf.body, _0x232cf.body = undefined) : ArrayBuffer.isView(_0x232cf.body) ? (_0x232cf.bodyBytes = _0x232cf.body.buffer.slice(_0x232cf.body.byteOffset, _0x232cf.body.byteLength + _0x232cf.body.byteOffset), _0x232cf.body = undefined) : _0x232cf.body && (_0x232cf.bodyBytes = undefined);
        _0x56c73a.log("🚩 执行结束!");
        $done(_0x232cf);
        break;
      case "Node.js":
